...
import com.lcvc.guojiaoyuan.yuliaoku.web.interceptor.LoginForAdminInterceptor;
import com.lcvc.guojiaoyuan.yuliaoku.web.interceptor.LoginForSuperAdminInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
       ...
       //管理员登陆拦截器
        registry.addInterceptor(loginForSuperAdminInterceptor())
                ...
                .addPathPatterns("/api/backstage/materialenglishhistory/manage/**")//要拦截的路径
                .excludePathPatterns(new LinkedList<String>(){{//不拦截的路径（一般指addPathPatterns中包含，但是不进行拦截的特例）
